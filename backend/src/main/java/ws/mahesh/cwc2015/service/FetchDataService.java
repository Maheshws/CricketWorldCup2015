...
public class FetchDataService {
    ...
    public static String LIVE_FEED_URL="http://www.espncricinfo.com/rss/content/story/feeds/509587.xml";
    ...
    public String getLiveFeed() {
        ...
        logger.fine("Live feed RSS: " + feed);
        return feed;
    }
